...
dims.use = 1:16 resolution = 1.6 might be best?
...
I think using more genes (original) analysis looks best as does including more PC dimensions in the FindClustersParams function. Probably PC =  1:14, resolution 1.6?
...
## Join Campbell repeats together
...
file_list<- c("SRR5164436", "SRR5164437", "SRR5164438", "SRR5164443", "SRR5164445")
...
## Use function to create an object for each mouse repeat:

file_list<- c("SRR5164436", "SRR5164437", "SRR5164438", "SRR5164443", "SRR5164445")

file_list2<- c("SRR5164436", "SRR5164437")

test<- Create_joined_seurat_object(file_list2)
dim(test)
test[c(1:6, 19000:19006),c(1:6, 19000:19006)]

file_list3<- c("SRR5164436", "SRR5164437", "SRR5164438")
test3<- Create_joined_seurat_object(file_list3)
dim(test3)
test3[c(1:6, 19000:19005, 24000:24005),c(1:6, 19000:19005, 24000:24005)]

campbell_CHOW_expression_matrix<- Create_joined_seurat_object(file_list)
